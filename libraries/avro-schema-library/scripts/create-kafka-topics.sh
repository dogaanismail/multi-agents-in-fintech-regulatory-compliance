...
create_topic "ledger.posting.requested.DLT" "Dead-letter for ledger-svc consumer"
create_topic "ledger.posting.completed.DLT" "Dead-letter for payment-engine-svc consumer"
create_topic "ledger.wallet.balance.changed.DLT" "Dead-letter for account-svc consumer"
