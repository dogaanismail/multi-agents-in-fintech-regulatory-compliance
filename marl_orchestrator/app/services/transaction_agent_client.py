"""
Transaction Pattern Agent Client
HTTP client for communication with Transaction Pattern Detection Agent
...
class TransactionAgentClient:
    """
    HTTP client for Transaction Pattern Agent
    
    Handles communication with the transaction pattern detection service
    """
    ...
    async def predict(self, features: Dict) -> AgentObservation:
        """
        Get prediction from Transaction Pattern Agent
        
        Args:
            features: Transaction features for prediction
        
        Returns:
            AgentObservation with prediction results
    ...
    async def health_check(self) -> bool:
        """
        Check health status of Transaction Agent
...
# Global instance
transaction_agent_client = TransactionAgentClient()
