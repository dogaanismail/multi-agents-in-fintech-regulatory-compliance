...
public record PaymentResponse(
        ...
        Instant ledgerAuthorisationInitiatedAt,
        Instant ledgerAuthorisedAt,
        Instant ledgerSettlementInitiatedAt,
        Instant ledgerSettledAt,
        Instant ledgerReleaseInitiatedAt,
        Instant ledgerReleasedAt,
        Instant completedAt,
        Instant blockedAt,
