...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<@NonNull CustomError> handleConfigNotFoundException(ConfigNotFoundException ex) {
    ...
    protected ResponseEntity<@NonNull CustomError> handleConfigAlreadyExistsException(ConfigAlreadyExistsException ex) {
