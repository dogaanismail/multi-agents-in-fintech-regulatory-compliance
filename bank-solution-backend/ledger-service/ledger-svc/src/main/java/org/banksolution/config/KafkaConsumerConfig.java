...
public class KafkaConsumerConfig {
    ...
    private static final long MAX_BACKOFF_MILLIS = 10000L;
    ...
    public <T> ConcurrentKafkaListenerContainerFactory<@NonNull String, @NonNull T> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<@NonNull String, @NonNull T> factory =
    ...
    public <T> ConsumerFactory<@NonNull String, @NonNull T> avroConsumerFactory() {
        DefaultKafkaConsumerFactory<@NonNull String, @NonNull T> consumerFactory =
                new DefaultKafkaConsumerFactory<>(getCommonConsumerConfigs());
    ...
    private DefaultErrorHandler createErrorHandler() {
        ...
        backOff.setInitialInterval(INITIAL_BACKOFF_MILLIS);
